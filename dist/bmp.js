...
var _a = require('@s-ayers/bitmap'), padImageData = _a.padImageData, createBitmapFile = _a.createBitmapFile;
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var pal, pp8, tile, width, height, colorTable, imageData;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                width = pp8.tiles.width;
                height = pp8.tiles.height * -1;
                colorTable = pal;
                imageData = padImageData({
